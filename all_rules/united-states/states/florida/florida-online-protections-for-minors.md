...
> Opening Note: Official Florida statutes source. Enforceability and litigation status should be verified before legal use.

- Collection: united-states
- Jurisdiction: Florida state law
- Scope Note: Applies only within the scope of Florida law; not nationwide federal law. Current enforceability may be affected by litigation or injunctions and must be checked before legal use.
- Source Authority: Online Sunshine / Florida Legislature
- Source URL:
...
- Status Note: Official Florida statutes source. Enforceability and litigation status should be verified before legal use.
- Source SHA-256:
