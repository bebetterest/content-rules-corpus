...
- Scope Note: Steam community rules and guidelines for discussions, reviews, and user generated content; not a government legal code.
...
- [How are these guidelines enforced?](sources/platform-steam-rules-guidelines.help-steampowered-com.html)

- [How can content be reported?](sources/platform-steam-rules-guidelines.help-steampowered-com.html)

- [What are Mature Content Preferences?](sources/platform-steam-rules-guidelines.help-steampowered-com.html)

- [What if content was removed by mistake?](sources/platform-steam-rules-guidelines.help-steampowered-com.html)

- [Why do moderators lock and delete discussions?](sources/platform-steam-rules-guidelines.help-steampowered-com.html)

- [What happens when these guidelines are violated?](sources/platform-steam-rules-guidelines.help-steampowered-com.html)

- [Why was my content removed when worse stuff exists?](sources/platform-steam-rules-guidelines.help-steampowered-com.html)

[section id=enforce][/section]
...
[section id=violate][/section]

#### What happens when these guidelines are violated?

The goal of these rules and guidelines is to create a community that is safe and appropriate for all players. Our priority is to remove content that violates these rules and guidelines. Next, the moderator evaluates the history of the account alongside the specific content to determine if warnings, bans, or feature cooldowns are necessary.
...
[section id=worse][/section]

#### Why was my content removed when worse stuff exists?

We understand that it can be frustrating to be on the receiving end of moderation actions when you are able to see other examples of similar behavior. However, the existence of rule-breaking content does not excuse or permit other violations.

If you find content that violates these rules and guidelines, we encourage you to report that content rather than engaging in similar behavior.

[Reporting Content & Behavior on Steam](https://help.steampowered.com/en/faqs/view/4DE7-17AA-0E8B-C1AD)
